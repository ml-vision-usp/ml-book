...
![Animação de convolução 1D](imagens/animacao-1d.gif)
...
![Animação de convolução 2D](imagens/animacao.gif)
...
![Animação de convolução 2D](imagens/media.gif)
...
![Comparação com cross-correlation](imagens/cross-correlation.png)
